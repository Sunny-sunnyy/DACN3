"""
BestBuy Deal Finder - Gradio Web App

Allows users to search for specific products on BestBuy by keyword.
Uses AI to estimate true value and find the best deals.

Workflow:
1. Search URLs (Brave MCP)
2. Filter sale items (BeautifulSoup)
3. Scrape details (Playwright)
...
# Ensure working directory is segment4
...
if __name__ == "__main__":
    print("=" * 60)
    print("🚀 BestBuy Deal Finder - Starting up...")
    print("=" * 60)
